<html>
    <body>
        ...
        <form action="elencoPren.jsp" method="POST">
        ...
        <%
            ...
            try{
                ...
                if(User != null){                                                
                        while(r.next()){
                            out.println("Sede ospitante: "+r.getString(1)+". Sport: "+r.getString(2)+". Giorno: "+r.getString(3)+". L'orario dato disponibile e': "+r.getString(4)+". Si trova in provincia di: "+r.getString(8)+". Il campo si trova a: "+r.getString(5)+". In via e numero: "+r.getString(6)+" "+r.getString(7));
                            out.println("<br>");
                        }
                }    
            }                     
        ...
        %>
        <input type="button" onclick="location.href='rimozionePren.jsp'" value="Metti a disposizione"/>
    </body>
</html>